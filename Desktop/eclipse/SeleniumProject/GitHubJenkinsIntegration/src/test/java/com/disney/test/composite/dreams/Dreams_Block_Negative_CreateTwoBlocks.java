 ...
 *           Dreams Block Negative CreateTwoBlocks.
 * @Precondition: N/A
...
public class Dreams_Block_Negative_CreateTwoBlocks {
	 ...
	 */
	@Test(dataProvider = "blockScenario", description = "Block Negative Create TwoBlocks", groups = {
			"regression", "dreams", "CreateGroupProfile", "OrgSearch",
			"contactGuestSearch", "GroupInfo", "createBlock", "errorMsg" })
	public void groupRatesAndAttrition(String testScenario, String role,
		...
		TestReporter.logStep("Validating the Error Message");
		groupProfilePage.validateErrorMessage(errorMsg);
	}
}
