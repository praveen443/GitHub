 ...
 * a table service and applying third-party preferences to the marketing
 * preferences
 * 
...
public class ALC_PTOI_DLR_NGF_NewRes_CA_TableService_CC_3rdParty {
	// *******************
	// Test Class Fields
	// *******************
	...
	public Object[][] scenarios() {
		try {
			...
			return dt.getTestScenariosByApp(application,
					"DLR_NGF_NewRes_CA_TableService_CC_3rdParty");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
