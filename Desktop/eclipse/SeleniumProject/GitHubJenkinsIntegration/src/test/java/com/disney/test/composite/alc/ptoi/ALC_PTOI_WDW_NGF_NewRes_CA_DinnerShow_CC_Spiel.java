 ...
 * a Dinner show and fetching the Spiel information
 * 
 * @author Lalitha Banda
 * @version 01/25/2016 Lalitha Banda - original
 */
@Listeners({ core.Screenshot.class })
public class ALC_PTOI_WDW_NGF_NewRes_CA_DinnerShow_CC_Spiel {
	// *******************
	// Test Class Fields
	// *******************
	...
	public Object[][] scenarios() {
		try {
			return dt.getTestScenariosByApp(application,
					"WDW_NGF_NewRes_CA_DinnerShow_CC_Spiel");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	 ...
	 */
	@Test(dataProvider = "dataProvider", description = "Test PTOI Marketing With WDW Non-Guest Facing Role, California Guest, Table Dining Event, CC Payment, 3rd Party", groups = {
