...
/**
 * @Summary: create view for children activity
 * @Precondition: N/A
...
public class ALC_CreateViewChildrenActivity {
	// *******************
	// Test Class Fields
	// *******************
	...
	@Test(dataProvider = "dataProvider", description = "Test PTOI Marketing With DLR Guest Facing Role, California Guest, Table Service Event, CC Payment, 3rd Party", groups = {
			...
			"Existing Reservation-Reservation tab", "Dicovery", "Offers",
			"Venue Information", "CC Guarantee" })
