 ...
 * a table service and fetching the Spiel information
 * 
 * @author Marella Satish
 * @version 01/21/2016 Marella Satish - original
 */
@Listeners({ core.Screenshot.class })
public class ALC_PTOI_DLR_GF_NewRes_CA_TableService_CC_Spiel {
	// *******************
	// Test Class Fields
	// *******************
	...
	public Object[][] scenarios() {
		try {
			...
			return dt.getTestScenariosByApp(application,
					"DLR_GF_NewRes_CA_TableService_CC_Spiel");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	 ...
	 */
	@Test(dataProvider = "dataProvider", description = "Test PTOI Marketing With DLR Guest Facing Role, California Guest, Table Service Event, CC Payment, Spiel Info", groups = {
